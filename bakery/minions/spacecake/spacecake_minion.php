...
$channel->queue_declare('bakery.rainbowcake.order', false, true, false, false);
...
$channel->basic_consume('bakery.rainbowcake.order', 'consumer', false, false, false, false, 'process_message');
